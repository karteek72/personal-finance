...
const SLIDES = [
  {
    ...
    content: (
      <div className="flex h-full flex-col items-center justify-center space-y-4 px-6 text-center">
        ...
        <p className="text-5xl font-extrabold leading-tight text-white">Your 2025<br />Wrapped</p>
    ...
    <>
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-bold text-white">Your 2025 Wrapped is ready</p>
